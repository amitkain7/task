      ...
      <div className='grid place-items-center  grid-cols-1 md:grid-cols-2 rounded-md gap-4 md:gap-10  bg-red-200 '>
        <div className='flex flex-col justify-center gap-2  py-2  '>
          ...
          <div className='flex bg-white p-1  gap-1 rounded-md cursor-pointer '>
            <img src="https://i.imgur.com/9wmBhTK.png" alt="appstore" className='w-6 h-6'/>
            ...
            <div className='flex bg-white p-1 gap-1 rounded-md cursor-pointer '>
            <img src="https://i.imgur.com/sYZYArm.png" alt="palystore" className='w-6 h-6' />
            <div className='flex flex-col '>
              <p className='text-xs font-light text-gray-700'>Download From</p>
        ...
        <div className=' flex pt-6'>
          <img src="https://i.imgur.com/BeAloJ1.png" alt="phone" width={'160px'} />
          <img src="https://i.imgur.com/HYZHbtH.png" alt="phone" width={'200px'} />
        </div>
      </div>
    </div>
  )
